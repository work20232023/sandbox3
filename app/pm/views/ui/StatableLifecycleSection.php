<?php
 ...
 class StatableLifecycleSection extends InfoSection
 {
 	...
 	function getRenderParms()
	{
		$rows = array();
        $lastComment = '';
        $lastDuration = $this->getObjectIt()->get('StateDurationRecent');
