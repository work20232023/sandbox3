...
include 'StatableLifecycleSection.php';
...
include 'AffectsRequirementsSection.php';
include 'DocumentationSection.php';
include 'SimilarSection.php';
...
class PMPage extends Page
{
    ...
    {
 	    return new BulkForm($this->getObject(), $entityFormClass);
    }
