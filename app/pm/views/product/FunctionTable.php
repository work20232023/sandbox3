...
class FunctionTable extends PMPageTable
{
	...
	function getFilters()
	{
		$filters = array(
            ...
            new FilterDateIntervalWebMethod(translate('Дата начала'), 'startafter'),
            new FilterDateIntervalWebMethod(translate('Дата начала'), 'startbefore'),
            new FilterDateIntervalWebMethod(translate('Дата завершения'), 'finishedafter'),
            new FilterDateIntervalWebMethod(translate('Дата завершения'), 'finishedbefore')
        );
	...
	function getFilterPredicates( $values )
	{
		$predicates = array(
            ...
            new FilterDateAfterPredicate('EstimatedStartDate', $values['startafter']),
            new FilterDateBeforePredicate('EstimatedStartDate', $values['startbefore']),
            new FilterDateAfterPredicate('EstimatedFinishDate', $values['finishedafter']),
            new FilterDateBeforePredicate('EstimatedFinishDate', $values['finishedbefore'])
		);
