...
class StateBaseModelBuilder extends ObjectModelBuilder 
{
    public function build( Metaobject $object )
    {
        ...
        foreach( array('Description','OrderNum','ReferenceName','ExcludeLeadTime','SkipEmailNotification','IsNotChange','IsNewArtifacts') as $attribute ) {
		...
		foreach( array('QueueLength') as $attribute ) {
            ...
            $object->addAttributeGroup($attribute, 'limits');
