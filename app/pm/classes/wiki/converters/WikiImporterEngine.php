...
{
    const SyntaxTagsRemove = ['p','div','br','img','span'];

    /** @var ?WikiImporterContentBuilder $builder */
    protected $builder;

    abstract protected function getHtml( $filePath );

    protected function postProcessPage(string $uid, IteratorBase $pageIt): void {}
    ...
    public function import( $builder, $documentTitle, $rawData, $parent_it )
    {
        ...
        foreach( $sections as $section ) {
            ...
            $this->postProcessPage($uid, $page_it);
