...
class WikiPageRegistryVersion extends ObjectRegistrySQL
{
	...
	function getQueryClause(array $parms)
	{
	    ...
	    return " (SELECT t.WikiPageId, t.UID, t.DocumentId, ".($this->snapshot_it->getId() > 0 ? "'{$this->snapshot_it->getDisplayName()}' DocumentVersion" : 't.DocumentVersion').", 
	                     i.DataHash, t.VPD, t.RecordVersion, IF(t.DataHash = i.DataHash, 0, 1) IsModified, ".join(",",$attributes).
