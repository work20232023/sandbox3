...
class RequestMetadataBuilder extends ObjectMetadataEntityBuilder 
{
    public function build( ObjectMetadata $metadata )
    {
	    ...
	    if ( $methodology_it->HasTasks() ) {
            ...
            $metadata->addAttributeGroup('Tasks', 'workitems');
        }
        ...
        $metadata->addAttribute( 'DownstreamLinks', 'REF_pm_ChangeRequestId', text('plan.implements'), false);
        $metadata->addAttributeGroup('DownstreamLinks', 'system');
        $metadata->addAttributeGroup('DownstreamLinks', 'trace');
        $metadata->addAttributeGroup('DownstreamLinks', 'workitems');
        $metadata->addPersister( new IssueLinkedIssuesPersister(array('Links','DownstreamLinks')) );
        ...
        foreach ( array('EstimationLeft','Fact', 'FactToday') as $attribute ) {
        ...
        if ( $strategy instanceof EstimationHoursStrategy ) {
            $metadata->setAttributeEditable('EstimationLeft', true);
