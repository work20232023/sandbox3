...
include "persisters/RequestLinkTypeSyncAttributesPersister.php";
...
include "predicates/RequestLinkedHasSyncedAttributesFilter.php";
include "predicates/RequestFinishAfterPredicate.php";
include "predicates/RequestOwnerIsNotTasksAssigneeFilter.php";
include "predicates/RequestLinkedByTypeFilter.php";
...
class Request extends MetaobjectStatable 
{
 	function __construct( $registry = null ) {
		parent::__construct('pm_ChangeRequest', $registry);
