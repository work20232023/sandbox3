...
$visibleAttributes = array_filter($attributes,
    function($item, $key) use ($skipFields) {
        return $item['visible'] && !in_array($item['type'], array('wysiwyg', 'text')) && !in_array($key, $skipFields);
            ...
            <div class="row">
                <div class="properties-cell-1">
                    ...
                    foreach( $attributes as $key => $attribute )
                    {
                        ...
                        <div class="accordion-body in collapse"<?=($attribute['type'] != 'text') ? 'style="overflow: hidden;"' : '';?>>
                            <?
                            if ($attribute['type'] == 'text') {
                                echo '<div class = "text-scroll">';
                                echo $view->render('core/PageFormViewAttribute.php', $attribute);
                                echo '<br />';
                                echo '</div>';
                            } else {
