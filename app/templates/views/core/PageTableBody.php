...
<div class="table-header <?=$tableClass?> hidden-print">
...
<div id="tablePlaceholder" class="<?=$placeholderClass?> <?=$sliderClass?>">
    ...
    if ( $leftPaneTemplate != '' ) {
        ?>
        <div class="treeview-push <?=($leftPaneVisible? 'invisible' : '')?>" onclick="toggleDocumentStructure()">
            <i class="icon-chevron-right"></i>
        </div>

        <?php
            echo $view->render($leftPaneTemplate, array_merge(
                        array(
                            'sections' => $sections,
