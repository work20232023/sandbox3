...
class AjaxForm
{
	...
	{
		return $this->getObject()->getAttributeEditable($attribute)
                    && getFactory()->getAccessPolicy()->can_modify_attribute($this->getObject(), $attribute);
	}
	...
	function drawAttribute( $attribute, $view )
	{
		...
		else
		{
			switch ( $attribute_type )
			{
				...
				case 'object':
                    $attributeGroups = $this->getObject()->getAttributeGroups($attribute);
