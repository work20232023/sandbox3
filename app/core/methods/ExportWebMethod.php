...
class ExportWebMethod extends WebMethod
{
	function getRedirectUrl() {
 	...
 	function execute_request()
 	{
        ...
        echo '&export=html&class='.urlencode(SanitizeUrl::parseUrl($_REQUEST['class'])).
 			 '&objects='.urlencode(SanitizeUrl::parseUrl($_REQUEST['objects'])).
 			 '&entity='.urlencode(SanitizeUrl::parseUrl($_REQUEST['entity'])).
             $title. '&redirect='.urlencode(urlencode($_REQUEST['redirect']));
 	}
}