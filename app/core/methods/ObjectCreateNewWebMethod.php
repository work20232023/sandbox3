...
class ObjectCreateNewWebMethod extends WebMethod
{
	...
	function execute_request()
    {
        ...
        $data = array (
            'Caption' => $object->getDefaultAttributeValue('Caption')
        );

        if ( $data['Caption'] == '' ) {
            $data['Caption'] = $object instanceof WikiPage
        ...
        {
            $type_it = $object->getAttributeObject('PageType')
                            ->getExact($object->getDefaultAttributeValue('PageType'));
