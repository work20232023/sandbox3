...
include "converters/WikiImporterEngineMail.php";
include "converters/WikiImporterEngineTxt.php";
...
class WikiImporterBuilderEditor extends WikiImporterBuilder
{
    ...
    function __sleep()
    {
        ...
        return ['pandocEnabled', 'libreOfficeEnabled'];
    }

    public function build(WikiImporterRegistry $registry, Metaobject $page)
    {
        $registry->add('WikiImporterEngineTxt');
        ...
        $registry->add('WikiImporterEngineMail');
    ...
    {
        try {
            if (!is_null($this->pandocEnabled)) {
                return $this->pandocEnabled;
            }
    ...
    {
        try {
            if (!is_null($this->libreOfficeEnabled)) {
                return $this->libreOfficeEnabled;
            }
