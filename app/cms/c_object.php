...
include('c_iterator.php'); 
 ...
 class AbstractObject
 {
	...
	{
        if ( !array_key_exists($attr, $this->attributes) ) return;
    ...
    function IsAttributeModifiable( $attribute )
    {
        return $this->IsAttributeRequired($attribute)
            && $this->IsAttributePersisted($attribute)
            && $this->getAttributeEditable($attribute)
            && $this->getAttributeType($attribute) !== 'file';
    }
