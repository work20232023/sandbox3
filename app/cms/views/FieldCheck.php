...
class FieldCheck extends Field
{
 	...
 	function draw( $view = null )
	{
		...
		<label class="checkbox">
			...
			<input id="<? echo $this->getId() ?>" tabindex="<? echo $this->getTabIndex() ?>" class="checkbox" name="<? echo $this->getName(); ?>" type="checkbox" <?=(in_array($this->getValue(), array('Y', 1, 'on', 'On')) ? 'checked' : '')?>
